...
export function reloadPresence(client) {
    ...
    .setType("PLAYING")
    .setName("Rader")
    .setDetails("Bot yapıyor")
    .setState("SoloQ (WORLD/1)")
    .setStartTimestamp(global.startTime)
    .setAssetsLargeImage("https://cdn.discordapp.com/attachments/1266162561531777114/1273224783579840573/OIG3.pAkaQdvQ4ko0GJmRKlw3.jpg?ex=66c1cafb&is=66c0797b&hm=f6abce6f2db61c08bf62fc80942f1427771fb66c792a97ed89995b0b11e9748c&")
    .setAssetsLargeText("Elderianor")
    .addButton('Discord', "https://discord.gg/razertr")
